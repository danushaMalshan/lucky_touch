...
const rounds = require("../controllers/rounds_controller.js");
...
module.exports = function(app) {
  ...
  app.post("/api/rounds/add",[authJwt.verifyToken],rounds.create);
//   app.post("/api/tickets/buyers/update/rank",[authJwt.verifyToken],ticket_buyers.updateRank);

  // Retrieve all Tutorials
  app.get("/api/last_round/get", [authJwt.verifyToken],rounds.findLastRound);
