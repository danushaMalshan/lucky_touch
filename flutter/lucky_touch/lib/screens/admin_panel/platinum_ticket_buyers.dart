...
class PlatinumTicketBuyers extends StatefulWidget {
  const PlatinumTicketBuyers({Key? key}) : super(key: key);

  @override
  State<PlatinumTicketBuyers> createState() => _PlatinumTicketBuyersState();
}

class _PlatinumTicketBuyersState extends State<PlatinumTicketBuyers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder(
          future:
              context.read<ModelGetPlatinumTicketBuyers>().getTicketBuyers(),
          builder: (context, snapshot) {
            if (snapshot.data != null &&
                context
                        .watch<ModelGetPlatinumTicketBuyers>()
                        .model
                        ?.data
                        ?.length !=
                    0) {
