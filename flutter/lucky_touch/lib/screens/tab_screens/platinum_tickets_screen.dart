...
class PlatinumTicketsScreen extends StatefulWidget {
  const PlatinumTicketsScreen({Key? key}) : super(key: key);

  @override
  State<PlatinumTicketsScreen> createState() => _PlatinumTicketsScreenState();
}

class _PlatinumTicketsScreenState extends State<PlatinumTicketsScreen> {
  ...
  _createPayment(BuildContext context, ticketId, amount, ticketType) async {
    createPayment = false;
    String apiKey =
        context.read<ModelPlatinumTicketScreen>().apiModel?.apiKey ?? '';
    Servicewrapper wrapper = new Servicewrapper();
    print('step 1');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
            ...
            child: FutureBuilder(
              future: context.read<ModelPlatinumTicketScreen>().getTickets(),
              builder: (context, snapshot) {
                if (snapshot.data != null &&
                    context
                            .watch<ModelPlatinumTicketScreen>()
                            .model
                            ?.data
                            ?.length !=
                        0) {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  context.read<ModelPlatinumTicketScreen>().getTickets();
                  Navigator.pop(context);
                },
                child: Container(
                  height: 60,
