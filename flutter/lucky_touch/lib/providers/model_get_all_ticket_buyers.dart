...
class ModelGetAllTicketBuyers extends ChangeNotifier {
  ...
  getTicketBuyers(String query) async {
    _dataLoading = true;

    _progress = true;

    Servicewrapper wrapper = new Servicewrapper();
    var res = await wrapper.getAllTicketBuyers(query);
    if (res == null) return;
    ...
    // }
    // var res2 = await wrapper.getAllTicketBuyers(query);
    // if (res == null) return;
