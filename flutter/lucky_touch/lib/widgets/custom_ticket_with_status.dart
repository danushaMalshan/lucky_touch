...
class CustomTicketWithStatus extends StatefulWidget {
  final int price;
  final int roundNo;
  final Color color;
  final String number;
  ...
  @override
  State<CustomTicketWithStatus> createState() => _CustomTicketWithStatusState();
}

class _CustomTicketWithStatusState extends State<CustomTicketWithStatus> {
